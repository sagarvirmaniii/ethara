...
const UserMenu = () => {
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        onClick={() => setOpen((o) => !o)}
        className="btn-press flex items-center gap-2 px-2 py-1.5 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1"
        aria-expanded={open}
        aria-haspopup="true"
      >
        ...
        <svg
          className={`hidden sm:block w-3.5 h-3.5 text-gray-400 transition-transform duration-150 ${open ? 'rotate-180' : ''}`}
        ...
        <div className="absolute right-0 top-full mt-1.5 w-64 bg-white rounded-xl shadow-lg border border-gray-100 z-50 overflow-hidden">
          ...
          <div className="p-2">
            <button
              ...
              className="btn-press w-full flex items-center gap-2.5 px-3 py-2 text-sm font-medium text-red-600 hover:bg-red-50 active:bg-red-100 rounded-lg"
            >
